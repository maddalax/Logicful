        ...
        <div class="container position-relative">
            ...
            <div class="d-flex align-items-center">
                <a href="https://themesberg.com/docs/pixel-bootstrap/getting-started/overview/" target="_blank"
                   class="btn btn-outline-soft d-none d-lg-inline mr-md-3 animate-up-2"><span
                        class="fas fa-book mr-2"></span> Docs v4.0</a>
                <a href="https://themesberg.com/product/ui-kit/pixel-pro-premium-bootstrap-5-ui-kit" target="_blank"
                   class="btn btn-tertiary animate-up-2"><span class="fas fa-shopping-cart mr-2"></span> Buy now</a>
