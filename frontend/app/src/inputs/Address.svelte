...
<div>
  <div class="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
    ...
    <div class="sm:col-span-2">
      <Field
        field={{ name: `${field.name}.state`, id: `${field.id}.value.state`, label: 'State', value: value?.state?.value, required: true, type: 'combobox', options: { type: 'remote', value: 'https://gist.githubusercontent.com/mshafrir/2646763/raw/8b0dbb93521f5d6889502305335104218454c2bf/states_hash.json' } }} />
    </div>
