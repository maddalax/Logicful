...
<div class="bg-white">
  <div class="relative bg-white">
    ...
    <!--
      ...
      -->
    <div
      class="absolute z-10 top-0 inset-x-0 p-2 transition transform
        ...
        <div class="bg-white rounded-lg shadow-xs divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5 space-y-6">
            ...
            <div class="space-y-6">
              <a
                href="#"
                class="w-full bg-purple-100 border border-transparent rounded-md
                  py-2 px-4 flex items-center justify-center text-base leading-6
              ...
              <p
                ...
                Existing customer? <a href="#" class="text-purple-600
                    hover:text-purple-500 transition ease-in-out duration-150"> Sign
                  in </a>
              </p>
            </div>
          </div>
  ...
  <div class="bg-gradient-to-b from-white to-gray-50">
      ...
      <div
        ...
        <div
          ...
          <div class="p-6">
            ...
            <p class="mt-8">
              <span
                class="text-4xl leading-10 font-extrabold text-gray-900">$24</span>
              <span
                class="text-base leading-6 font-medium text-gray-500">/mo</span>
            </p>
            <button
        ...
        <div
          ...
          <div class="p-6">
            ...
            <p class="mt-8">
              <span
                class="text-4xl leading-10 font-extrabold text-gray-900">$32</span>
              <span
                class="text-base leading-6 font-medium text-gray-500">/mo</span>
            </p>
            <button
    ...
    <div class="max-w-screen-xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
      ...
      <dl
        class="mt-12 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:col-gap-6
          sm:row-gap-12 lg:grid-cols-4 lg:col-gap-8">
        ...
        <div class="flex space-x-3">
          ...
          <div class="space-y-2">
            ...
            <dd class="flex space-x-3">
              <span class="text-base leading-6 text-gray-500">Etiam cras augue
                ornare pretium sit malesuada morbi orci, venenatis. Dictum
                lacus.</span>
            </dd>
          </div>
        </div>
      ...
      <div class="lg:space-y-10">
        ...
        <div class="mt-8 flow-root lg:mt-0">
          <div class="-mt-4 -ml-8 flex flex-wrap justify-between lg:-ml-4">
            <div
              class="mt-4 ml-8 flex flex-grow flex-shrink-0 lg:flex-grow-0
                lg:ml-4">
              <img
                class="h-12"
      ...
      <div class="space-y-4">
        ...
        <p class="text-lg leading-7 text-gray-500">
          Can’t find the answer you’re looking for? Reach out to our <a
            href="#"
            class="font-medium text-purple-600 hover:text-purple-500 transition
              duration-150 ease-in-out">customer support</a> team.
        </p>
      </div>
  ...
  <footer class="bg-gray-900">
    <div class="max-w-screen-xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
      ...
      <div class="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
        <div class="grid grid-cols-2 gap-8 xl:col-span-4">
          <div class="md:grid md:grid-cols-2 md:gap-8">
            <div>
              <h3
                class="text-sm leading-5 font-semibold text-gray-400
        ...
        <div class="mt-12 xl:mt-0">
          <h3
            class="text-sm leading-5 font-semibold text-gray-400 tracking-wider
              uppercase">
            Language &amp; Currency
          </h3>
          <form class="mt-4 space-y-4 sm:max-w-xs">
            <fieldset class="w-full">
              ...
              <div class="relative">
                <select
                  id="language"
                  class="appearance-none block w-full bg-gray-800 border
                    border-transparent rounded-md py-2 pl-3 pr-10 text-base
                    leading-6 text-white focus:outline-none
                ...
                <div
                  class="pointer-events-none absolute inset-y-0 right-0 px-2
                    flex items-center"
                  aria-hidden="true">
                  <!-- Heroicon name: chevron-down -->
                  <svg
      ...
      <div
        class="border-t border-gray-700 pt-8 space-y-4 lg:space-y-0 lg:flex
          lg:items-center lg:justify-between xl:mt-0">
        <div class="space-y-2">
          <h3
            class="text-sm leading-5 font-semibold text-gray-400 tracking-wider
              uppercase">
        ...
        <form class="sm:flex sm:max-w-md">
          ...
          <input
            ...
            class="appearance-none min-w-0 w-full bg-white border
              border-transparent rounded-md py-2 px-4 text-base leading-6
          ...
          <div class="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
            <button
              type="submit"
              class="w-full bg-purple-600 border border-transparent rounded-md
                py-2 px-4 flex items-center justify-center text-base leading-6
                font-medium text-white hover:bg-purple-500 focus:outline-none
                focus:border-purple-700 focus:shadow-outline-purple
      ...
      <div
        class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center
          md:justify-between">
