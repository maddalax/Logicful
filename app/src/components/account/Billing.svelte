                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" placeholder="Dallas" class="form-control" id="cartInputCity1">
                        </div>
                        <!-- End of Form -->
                    </div>
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" placeholder="123456" class="form-control" id="cartInputZip1">
                        </div>
                        <!-- End of Form -->
                    </div>
                    <div class="col-12 col-lg-6">
                    ...
                    <div class="col-12 col-lg-6">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" placeholder="+(12)345 6789" class="form-control" id="cartInputPhone1">
                        </div>
                        <!-- End of Form -->
                    </div>
                    <div class="col-12">
