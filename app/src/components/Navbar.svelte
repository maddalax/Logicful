    ...
    <div class="container position-relative">
      ...
      <div class="navbar-collapse collapse mr-auto" id="navbar_global">
        ...
        <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" id="componentsDropdown" aria-expanded="false" data-toggle="dropdown">
              Components
              <span class="fas fa-angle-down nav-link-arrow ml-1" />
            </a>
              ...
              <div class="row g-0">
                <div class="col-lg-6 bg-dark d-none d-lg-block pr-0 mr-3">
                  ...
                  <div class="z-2 pb-3 text-center">
                    <a href="../../html/components/all.html" class="btn btn-outline-white animate-up-2 mb-2 mb-sm-0 mr-3">
                      <span class="mr-1">
                        <span class="fas fa-th-large" />
                      </span>
                      All components
                    </a>
                    <a href="../../html/sections/all-sections.html" class="btn btn-tertiary animate-up-2 mb-2 mb-sm-0">
                      <span class="mr-1">
                ...
                <div class="col pl-0 py-3">
                  <ul class="list-style-none">
                    ...
                    <li>
                      <a class="dropdown-item" href="../../html/components/charts.html">Charts</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="dropdown-item" href="../../html/components/counters.html">Counters</a>
                    </li>
                  </ul>
                </div>
                <div class="col pl-0 py-3">
                  <ul class="list-style-none">
                    <li>
                      <a class="dropdown-item" href="../../html/components/dropdowns.html">Dropdowns</a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="../../html/components/e-commerce.html">E-commerce</a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="../../html/components/forms.html">Forms</a>
                    </li>
                    <li>
                      <a class="dropdown-item" href="../../html/components/icon-boxes.html">Icon Boxes</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="dropdown-item" href="../../html/components/glidejs-carousels.html">GlideJS Carousels</a>
                    </li>
                    <li>
                ...
                <div class="col pl-0 py-3">
                  <ul class="list-style-none">
                    ...
                    <li>
                      <a class="dropdown-item" href="../../html/components/steps.html">Steps</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="dropdown-item" href="../../html/components/timelines.html">Timelines</a>
                    </li>
                    <li>
                    ...
                    <li>
                      <a class="dropdown-item" href="../../html/components/widgets.html">Widgets</a>
                    </li>
                  </ul>
                </div>
              </div>
          ...
          <li class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" id="supportDropdown" aria-expanded="false">
              Support
              <span class="fas fa-angle-down nav-link-arrow ml-1" />
            </a>
                  ...
                  <a
                    ...
                    <div class="ml-4">
                      <span class="d-block font-small font-weight-bold mb-0">
                        Documentation
                        <span class="badge badge-sm badge-secondary ml-2">v3.1</span>
                      </span>
      ...
      <div class="d-flex align-items-center">
        <a href="https://themesberg.com/product/ui-kit/pixel-pro-premium-bootstrap-5-ui-kit" target="_blank" class="btn btn-outline-soft animate-up-2">
