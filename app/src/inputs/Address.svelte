...
<Label field={{ label: 'Address', type: 'address', id: randomString(), required : field.required }} />
<div class="row" style="width: 100%;">
  <div class="col">
    ...
    <div class="row" style="padding-top: 0.8em;">
      <div class="col-5">
        <LiveField field={{ required: true, name: `${field.name}.city`, id: `${field.id}.value.city`, helperText: 'City', hideLabel: true, value: value?.city?.value ?? '', type: 'string' }} />
      </div>
      <div class="col-3">
        <LiveField
