...
{#if mode === 'local'}
  <div class="alert alert-info alert-dismissible fade show" style="border-radius: 0;" role="alert">
    You are viewing a live preview of how your form will display and act once it is published. This preview will
    <strong>live update</strong>
    when changes are made from the form builder, no save neeed.
