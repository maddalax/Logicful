...
<Field field={{ id: randomString(), required: true, label: 'Form Description', value: { type: 'local', value: form.description }, type: 'string', configFieldTarget: 'description', configTarget: 'form' }} />
