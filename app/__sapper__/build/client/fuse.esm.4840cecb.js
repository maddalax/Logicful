...
function get(obj, path) {
  ...
  const deepGet = (obj, path, index) => {
    if (!path[index]) {
      ...
      if (
        index === path.length - 1 &&
        (isString$1(value) || isNumber(value) || isBoolean(value))
      ) {
...
export { Fuse as F, LoadState as L, fastEquals as a, isFunction as b, isObject as c, randomStringSmall as d, isEmptyOrNull as e, fastClone as f, isLabelValue as g, isString as i, nullOrEmpty as n, randomString as r, stringEquals as s, toNumberOrDefault as t };
