...
let MongoService = class MongoService {
    constructor(provider) {
        ...
        this.client = new mongodb_1.MongoClient(provider.get("mongodb:connection"));
    }
    async connect() {
...
MongoService = __decorate([
    ...
    __param(0, inversify_1.inject(ConfigProvider_1.ConfigProvider)),
    __metadata("design:paramtypes", [ConfigProvider_1.ConfigProvider])
], MongoService);
