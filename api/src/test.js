...
var ddb = new AWS.DynamoDB({apiVersion: '2012-08-10', endpoint : "http://localhost:8000"});
...
var params = {
  RequestItems: {
    "forms": {
        "Keys": [
            {
                "id": {"S": "31852cb9-f4ed-49dd-abd0-c37f8fb0c52e"},
                "timestamp": {"N": "1596838514283"}
            }
        ]
    }
}
...
ddb.batchGetItem(params, function(err, data) {
  if (err) {
    ...
    console.log(data);
    data.Responses.forms.forEach(function(element, index, array) {
      console.log(element);
    });
  }
});
