 ...
 * @param {number} index of the item in being morphed.
 */
export function morphDraggedElementToBeLike(draggedEl, copyFromEl, currentMouseX, currentMouseY,  transformDraggedElement, index) {
