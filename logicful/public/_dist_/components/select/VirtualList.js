import './VirtualList.css.proxy.js';
/* src/components/select/VirtualList.svelte generated by Svelte v3.25.1 */
import {
	SvelteComponent,
	add_render_callback,
	add_resize_listener,
...
// (131:4) {#each visible as row (row.index)}
