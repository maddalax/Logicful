  ...
  <div class="flex-1 min-w-0">
    ...
    <div class="mt-1 flex flex-col sm:mt-0 sm:flex-row sm:flex-wrap">
        ...
        <div
          ...
          <span
            class="inline-flex items-center px-3 py-0.5 rounded-full text-sm
              font-medium leading-5 bg-purple-100 text-purple-800 hover:font-bold">
      ...
      <div
        ...
        <a
          href={'/form/submissions?formId=' + form.id}
          target="_blank">{form.submissionCount} Total Submissions</a>
      </div>
      <div
        class="mt-2 flex items-center text-sm leading-5 text-gray-500 sm:mr-6">
        <svg
          ...
          <path
            ...
            clip-rule="evenodd" />
        </svg> Last Updated - {new Date(form.changeDate ?? new Date()).toLocaleDateString()}
      </div>
    </div>
  </div>
