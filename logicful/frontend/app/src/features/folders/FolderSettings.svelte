...
{#if deleting}
  <Dialog isOpen={true} actions={deleteActions} title={`Confirm Deletion For ${folder.name}`} {onClose}>
    <p>Are you sure you want to delete this folder? All forms in this folder will be moved to uncategorized.</p>
  </Dialog>
{/if}
