...
-->
  <div
    class="relative pt-8 pb-20 px-4 sm:px-6 lg:pt-8 lg:pb-28 lg:px-8">
      ...
      <div
        ...
        <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
          <div class="flex-shrink-0">
            <svg class="ml-3"  xmlns="http://www.w3.org/2000/svg" width="95%" height="100%" viewBox="0 0 804.739 610.284">
              <g id="Group_42" data-name="Group 42" transform="translate(-194 -123)">
                ...
                <rect id="Rectangle_316" data-name="Rectangle 316" width="152.813" height="114.61" transform="translate(568.796 553.255)" fill="#6c63ff"/>
                ...
                <rect id="Rectangle_324" data-name="Rectangle 324" width="106.739" height="80.054" transform="translate(247.364 164.361)" fill="#6c63ff"/>
                ...
                <g id="Group_41" data-name="Group 41" transform="translate(-9.234 -16.468)">
                  <ellipse id="Ellipse_220" data-name="Ellipse 220" cx="55.409" cy="55.409" rx="55.409" ry="55.409" transform="translate(416.234 351.468)" fill="#6c63ff"/>
          ...
          <div class="flex-1 bg-white p-6 flex flex-col justify-between">
            ...
            <div class="mt-6 flex items-center">
              <Button type="primary" width="full" onClick={createNewForm}>Create</Button>
            </div>
          </div>
        </div>
        <div class="flex flex-col rounded-lg shadow-lg overflow-hidden">
          ...
          <div class="flex-1 bg-white p-6 flex flex-col justify-between">
            ...
            <div class="mt-6 flex items-center">
              <Button type="primary" disabled={true} width="full">Create</Button>
            </div>
          </div>
        </div>
      </div>
