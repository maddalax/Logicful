      ...
      <div class="flex items-center">
        <div class="flex-shrink-0">
          <span class="rounded-md shadow-sm">
            <button type="button" class="relative inline-flex items-center px-4 py-2 border border-transparent text-sm leading-5 font-medium rounded-md text-white bg-blue-500 hover:bg-blue-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-600 active:bg-blue-600 transition duration-150 ease-in-out">
              <!-- Heroicon name: plus -->
  ...
  <div class="hidden md:hidden">
    ...
    <div class="pt-4 pb-3 border-t border-gray-700">
      <div class="flex items-center px-5 sm:px-6">
        ...
        <div class="ml-3">
          <div class="text-base font-medium leading-6 text-white">Maddox</div>
